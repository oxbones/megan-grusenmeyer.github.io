...
_.first = function first(array, num) {
  var result;
  if (!Array.isArray(array)) {
    ...
    result = array.slice(0, num) //number items of array
  }
  return result
}
...
_.last = function last(array, num) {
  var result;
  if (!Array.isArray(array)) {
    result = [];
  } else if (isNaN(num)){
    ...
    result = array.slice(-num) //number items of array
  }
  return result
}
